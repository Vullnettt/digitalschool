...
public class SubjectController {
    ...
    @PatchMapping(path = "/v1/subjects/{id}")
    @Operation(
            description = "Partial update subject by providing fields of entity in body and id in path",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = "The Subject Update Successfully",
    ...
    public ResponseEntity<SubjectDto> partialUpdate(@PathVariable Long id, @RequestBody SubjectDto subjectDto){
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "204",
                            description = "The Subject Deleted Successfully"
                    ),
                    @ApiResponse(
                            responseCode = "400",
                            description = "Bad Request",
